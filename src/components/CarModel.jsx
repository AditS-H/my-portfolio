...
function CarModel({ scrollProgress }) {
  const { scene, nodes, materials } = useGLTF('https://api.codetabs.com/v1/proxy/?quest=https://github.com/AditS-H/my-portfolio/releases/download/v1.0.0/car_lowres.glb')
